/*! For license information please see 86b88329bd0469bc.vendor.js.LICENSE.txt */
  ...
  [98821],
  {
    ...
    214003: (t, e) => {
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }),
        (e.Variable = e.Snapshot = e.currentSnapshot = void 0);
      const n = Symbol("Snapshot.wrapped");
      e.currentSnapshot = { value: void 0 };
      class r {
        constructor() {
          null != e.currentSnapshot.value &&
            (this.parentSnapshot = e.currentSnapshot.value),
            (this.run = this.run.bind(this));
        }
        run(t, ...n) {
          const r = e.currentSnapshot.value;
          e.currentSnapshot.value = this;
          try {
            return t.call(null, ...n);
          } finally {
            e.currentSnapshot.value = r;
          }
        }
        static wrap(t) {
          if ("function" != typeof t || t[n]) return t;
          const r = e.currentSnapshot.value,
            i = function (...n) {
              const i = e.currentSnapshot.value;
              e.currentSnapshot.value = r;
              try {
                return t.call(this, ...n);
              } finally {
                e.currentSnapshot.value = i;
              }
            };
          return (i[n] = !0), i;
        }
      ...
      (e.Variable = class {
        ...
        run(t, e, ...n) {
          const i = new r();
          return this.snapshotToValue.set(i, t), i.run(e, ...n);
        }
      }),
        (e.currentSnapshot.value = new r());
    },
    218083: (t, e, n) => {
      "use strict";
      function r(t) {
    ...
    275982: (t, e, n) => {
      "use strict";
      Object.defineProperty(e, "__esModule", { value: !0 }),
        (e.$_AsyncContext_Start = void 0);
      const r = n(214003);
      e.$_AsyncContext_Start = (t = !1) => {
        let e = r.currentSnapshot.value;
        const n = e;
        let i = t;
        return () => ({
          s: (t) => (i || ((i = !0), (r.currentSnapshot.value = e)), t),
          r: (t) => (
            i && (e = r.currentSnapshot.value),
            (i = !1),
            (r.currentSnapshot.value = n),
            t
          ),
        });
      };
    ...
    447524: (t, e) => {
      ...
      function G(t, e) {
        ...
        for (let r = 0; r < o; r++) {
          ...
          t.enableVertexAttribArray(i), s.set(e.name, { location: i, meta: o });
        }
      ...
      class $ {
              ...
              if (this.onContextLost) {
                ...
                t &&
                  (e =
                    ...
                    "No statusMessage"),
                  this.onContextLost(new o(`Error: WebGL context lost - ${e}`));
              }
            }),
        ...
        clear(t, e) {
          ...
          const i = Array.isArray(t),
            ...
            l = void 0 !== a,
            h = void 0 !== c;
          u && r.clearColor(...s), l && r.clearDepth(a), h && r.clearStencil(c);
          const f =
        ...
        (e.GltfParser = class {
          ...
          async getModel(t, e, n = []) {
            const r = (void 0 === t ? this.nodes : t).map((t) => {
              const r = ae(t, e);
              return (
                t.children.length > 0 && this.getModel(t.children, t, n), r
              );
            });
                  ...
                  switch (t.targetProperty.toLocaleLowerCase()) {
                    case "translation":
                      (n.animation.transform.values =
                        ...
                        (n.animation.transform.interpolation = t.interpolation);
                      break;
                    case "rotation":
    ...
    702183: (t, e, n) => {
      ...
      function o(t) {
        return (
          void 0 === t && (t = Number.POSITIVE_INFINITY), (0, r.ZZ)(i.D, t)
        );
      }
    },
    709387: (t, e, n) => {
...
//# sourceMappingURL=sourcemaps/86b88329bd0469bc.vendor.js.map

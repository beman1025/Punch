  ...
  [59880],
  {
    244059: (e, t, n) => {
      ...
      function b() {
        return (
          (null !== i && 0 !== i.byteLength) ||
            (i = new Uint8Array(r.memory.buffer)),
          i
        );
      }
      function c(e, t) {
        return (e >>>= 0), _.decode(b().subarray(e, e + t));
      }
      function o(e) {
      ...
      function d(e, t, n) {
        ...
        if (c !== r) {
          0 !== c && (e = e.slice(c)),
            (_ = n(_, r, (r = c + 3 * e.length), 1) >>> 0);
          const t = b().subarray(_ + c, _ + r);
          (c += s(e, t).written), (_ = n(_, r, c, 1) >>> 0);
        }
        return (u = c), _;
      }
      let l = null;
      function h() {
        return (
          (null === l ||
            !0 === l.buffer.detached ||
            (void 0 === l.buffer.detached && l.buffer !== r.memory.buffer)) &&
        ...
        const i = { a: e, b: t, cnt: 1, dtor: n },
          b = (...e) => {
            ...
            try {
              ...
              0 == --i.cnt &&
                (r.__wbindgen_export_6.get(i.dtor)(i.a, i.b),
                (i.a = 0),
                p.unregister(i));
            }
          };
        ...
        const i = { a: e, b: t, cnt: 1, dtor: n },
          b = (...e) => {
            ...
            try {
              ...
              0 == --i.cnt
                ? (r.__wbindgen_export_6.get(i.dtor)(t, i.b), p.unregister(i))
                : (i.a = t);
            }
          };
        return (b.original = i), p.register(b, i, i), b;
      ...
      function I(e, t) {
        r._dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hda1b6da603091a1f(
          e,
          t
        );
      }
      function R(e, t, n) {
        r.closure184_externref_shim(e, t, n);
      }
      function F(e, t) {
        r._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0f70d4e01d040ed3(
          e,
          t
        );
      }
      function L(e, t, n) {
        r.closure433_externref_shim(e, t, n);
      }
      const E = ["omit", "same-origin", "include"],
        S = ["same-origin", "no-cors", "cors", "navigate"],
        T =
          "undefined" == typeof FinalizationRegistry
            ? { register: () => {}, unregister: () => {} }
            : new FinalizationRegistry((e) =>
                r.__wbg_binarytexture_free(e >>> 0, 1)
              );
      let P = class {
        __destroy_into_raw() {
      ...
      const U =
        "undefined" == typeof FinalizationRegistry
          ? { register: () => {}, unregister: () => {} }
          : new FinalizationRegistry((e) =>
              r.__wbg_elementsbuffer_free(e >>> 0, 1)
            );
      let B = class {
        __destroy_into_raw() {
          const e = this.__wbg_ptr;
      ...
      const z =
        "undefined" == typeof FinalizationRegistry
          ? { register: () => {}, unregister: () => {} }
          : new FinalizationRegistry((e) =>
              r.__wbg_gltfrendererinternal_free(e >>> 0, 1)
            );
      class O {
        __destroy_into_raw() {
          const e = this.__wbg_ptr;
        ...
        setRecolorings(e) {
          r.gltfrendererinternal_setRecolorings(this.__wbg_ptr, e);
        }
        dispose_webgl(e) {
      ...
      const j =
        "undefined" == typeof FinalizationRegistry
          ? { register: () => {}, unregister: () => {} }
          : new FinalizationRegistry((e) =>
              r.__wbg_gltfresource_free(e >>> 0, 1)
            );
      let M = class {
        __destroy_into_raw() {
          const e = this.__wbg_ptr;
      ...
      const C =
        "undefined" == typeof FinalizationRegistry
          ? { register: () => {}, unregister: () => {} }
          : new FinalizationRegistry((e) =>
              r.__wbg_imagetexture_free(e >>> 0, 1)
            );
      let W = class {
        __destroy_into_raw() {
          const e = this.__wbg_ptr;
      ...
      const q =
        "undefined" == typeof FinalizationRegistry
          ? { register: () => {}, unregister: () => {} }
          : new FinalizationRegistry((e) =>
              r.__wbg_rendertexture_free(e >>> 0, 1)
            );
      let G = class {
        __destroy_into_raw() {
          const e = this.__wbg_ptr;
      ...
      let $ = class e {
        ...
        constructor(e) {
          ...
          return (
            (this.__wbg_ptr = t >>> 0),
            N.register(this, this.__wbg_ptr, this),
            this
          );
        }
        update(e) {
      ...
      const Q =
        "undefined" == typeof FinalizationRegistry
          ? { register: () => {}, unregister: () => {} }
          : new FinalizationRegistry((e) =>
              r.__wbg_webglrenderer_free(e >>> 0, 1)
            );
      class X {
        __destroy_into_raw() {
          const e = this.__wbg_ptr;
        ...
        return (
          ...
          (e.wbg.__wbg_addEventListener_4220b29000fe3462 = function () {
            return a(function (e, t, n, r, _) {
              e.addEventListener(c(t, n), r, _);
            }, arguments);
          }),
          (e.wbg.__wbg_append_8c7dd8d641a5f01b = function () {
            return a(function (e, t, n, r, _) {
              e.append(c(t, n), c(r, _));
            }, arguments);
          }),
          ...
          (e.wbg.__wbg_getAttribLocation_9db82d01924fa43d = function (
            ...
            return e.getAttribLocation(t, c(n, r));
          }),
          ...
          (e.wbg.__wbg_getProgramInfoLog_631c180b1b21c8ed = function (e, t, n) {
            ...
            var i = g(_) ? 0 : d(_, r.__wbindgen_malloc, r.__wbindgen_realloc),
              b = u;
              ...
              const _ = new Promise((e, t) => {
                ...
                try {
                  return (function (e, t, n, _) {
                    r.closure685_externref_shim(e, t, n, _);
                  })(_, n.b, e, t);
                } finally {
                  n.a = _;
                }
          ...
          (e.wbg.__wbg_readPixels_05b426266eb8041a = function () {
            return a(function (e, t, n, r, _, i, b, c, o) {
              e.readPixels(
                t,
                n,
                r,
          ...
          (e.wbg.__wbg_removeEventListener_709135c542708608 = function () {
            return a(function (e, t, n, r) {
              e.removeEventListener(c(t, n), r);
            }, arguments);
          }),
          (e.wbg.__wbg_removeEventListener_a84e3f7cc5932d93 = function () {
            return a(function (e, t, n, r, _) {
              e.removeEventListener(c(t, n), r, _);
            }, arguments);
          }),
          ...
          (e.wbg.__wbg_texImage2D_297bb8474cd4e8b8 = function () {
            return a(function (e, t, n, r, _, i, b, c, o, a, g) {
              e.texImage2D(
                t >>> 0,
                n,
                r,
          ...
          (e.wbg.__wbg_texImage2D_7b15c62fc9c12b16 = function () {
            return a(function (e, t, n, r, _, i, b) {
              e.texImage2D(t >>> 0, n, r, _ >>> 0, i >>> 0, b);
            }, arguments);
          }),
          ...
          (e.wbg.__wbg_texImage2D_b8edcb5692f65f88 = function () {
            return a(function (e, t, n, r, _, i, b, c, o, a) {
              e.texImage2D(t >>> 0, n, r, _, i, b, c >>> 0, o >>> 0, a);
            }, arguments);
          }),
          ...
          (e.wbg.__wbg_vertexAttribPointer_7a2a506cdbe3aebc = function (
            ...
            e.vertexAttribPointer(t >>> 0, n, r >>> 0, 0 !== _, i, b);
          }),
          ...
          (e.wbg.__wbindgen_bigint_get_as_i64 = function (e, t) {
            ...
            h().setBigInt64(e + 8, g(n) ? BigInt(0) : n, !0),
              h().setInt32(e + 0, !g(n), !0);
          }),
          ...
          (e.wbg.__wbindgen_closure_wrapper1873 = function (e, t, n) {
            return y(e, t, 181, I);
          }),
          (e.wbg.__wbindgen_closure_wrapper1875 = function (e, t, n) {
            return y(e, t, 181, R);
          }),
          (e.wbg.__wbindgen_closure_wrapper2344 = function (e, t, n) {
            return m(e, t, 325, F);
          }),
          (e.wbg.__wbindgen_closure_wrapper3047 = function (e, t, n) {
            return m(e, t, 434, L);
          }),
          ...
          (e.wbg.__wbindgen_string_get = function (e, t) {
            ...
            var _ = g(n) ? 0 : d(n, r.__wbindgen_malloc, r.__wbindgen_realloc),
              i = u;
      ...
      async function Z(e) {
        ...
        void 0 !== e &&
          ...
          void 0 === e &&
            (e = new URL(
              "" + new URL(n(788226), n.b).href,
              "file:///mnt/engflow/worker/work/5/exec/bazel-out/k8-opt-exec-ST-50735076bf96/bin/web/src/pages/export_website/webpack_cli_page_/webpack_cli_page.runfiles/_main/node_modules/.aspect_rules_js/@canva+fragl-rs@0.5.0/node_modules/@canva/fragl-rs/dist/fragl.js"
            ));
        const t = Y();
        ("string" == typeof e ||
          ...
          (e = fetch(e));
        const { instance: _, module: b } = await (async function (e, t) {
      ...
      class ne extends te(V) {}
      class re extends te(D) {}
      class _e extends te(B) {}
      class ie extends te(P) {}
      class be extends te(W) {}
      class ce extends te(G) {}
      class oe extends te($) {}
      class ae extends te(M) {}
      class fe {
        constructor(e) {
        ...
        createBackend() {
          ...
          return (
            "onContextLost" in e &&
              (e.onContextLost = (e) => this.onContextLost?.(e)),
            e
          );
        }
        load(e) {
        ...
        clear(e, t) {
          const n = Array.isArray(e) ? { color: e } : e;
      ...
      function ge(e, t) {
        ...
        const i = {
          ...
          b = t?.useWebGl2
            ? n.getContext("webgl2", i)
            : n.getContext("webgl", i);
        if ((n.removeEventListener("webglcontextcreationerror", _), !b))
      ...
      async function we(e = {}) {
        const { memory: t } = e.path
          ? await Z({ module_or_path: e.path })
          : await Z();
        return { memory: t };
      }
      (V.prototype.resourceType = "shader"),
        (D.prototype.resourceType = "buffer"),
        (B.prototype.resourceType = "elements"),
        (W.prototype.resourceType = "texture"),
        (P.prototype.resourceType = "texture"),
        (G.prototype.resourceType = "texture");
    },
    328611: (e, t, n) => {
      let r;
      n.r(t),
      ...
      function i() {
        return (
          (null !== _ && 0 !== _.byteLength) ||
            (_ = new Uint8Array(r.memory.buffer)),
          _
        );
      }
      function b(e, t) {
      ...
      function w(e, t, n) {
        ...
        if (c !== r) {
          0 !== c && (e = e.slice(c)),
            (_ = n(_, r, (r = c + 3 * e.length), 1) >>> 0);
          const t = i().subarray(_ + c, _ + r);
          (c += u(e, t).written), (_ = n(_, r, c, 1) >>> 0);
        }
        return (f = c), _;
      }
      let s = null;
      function d() {
        return (
          (null === s ||
            !0 === s.buffer.detached ||
            (void 0 === s.buffer.detached && s.buffer !== r.memory.buffer)) &&
      ...
      function h(e, t) {
        return (e >>>= 0), l.decode(i().subarray(e, e + t));
      }
        ...
        const i = { a: e, b: t, cnt: 1, dtor: n },
          b = (...e) => {
            ...
            try {
              ...
              0 == --i.cnt &&
                (r.__wbindgen_export_5.get(i.dtor)(i.a, i.b),
                (i.a = 0),
                p.unregister(i));
            }
          };
      ...
      function v(e, t) {
        ...
        return i().set(e, n / 1), (f = e.length), n;
      }
      function A(e, t, n) {
        x(e, U);
        const _ = v(t, r.__wbindgen_malloc),
          i = f,
          b = v(n, r.__wbindgen_malloc),
          c = f;
        return r.loadEnvTextures(e.__wbg_ptr, _, i, b, c);
      }
      function I(e, t) {
        r._dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h55f2a4e7116360cb(
          e,
          t
        );
      }
      function R(e, t, n) {
        r.closure4_externref_shim(e, t, n);
      }
      function F(e, t, n) {
        r.closure485_externref_shim(e, t, n);
      }
      const L =
        "undefined" == typeof FinalizationRegistry
          ? { register: () => {}, unregister: () => {} }
          : new FinalizationRegistry((e) =>
              r.__wbg_envtextures_free(e >>> 0, 1)
            );
      class E {
        static __wrap(e) {
          e >>>= 0;
          const t = Object.create(E.prototype);
          return (t.__wbg_ptr = e), L.register(t, t.__wbg_ptr, t), t;
        }
        __destroy_into_raw() {
          const e = this.__wbg_ptr;
      ...
      const S =
        "undefined" == typeof FinalizationRegistry
          ? { register: () => {}, unregister: () => {} }
          : new FinalizationRegistry((e) =>
              r.__wbg_meshrenderer_free(e >>> 0, 1)
            );
      class T {
        static __wrap(e) {
          e >>>= 0;
          const t = Object.create(T.prototype);
          return (t.__wbg_ptr = e), S.register(t, t.__wbg_ptr, t), t;
        }
        __destroy_into_raw() {
          const e = this.__wbg_ptr;
        ...
        free() {
          const e = this.__destroy_into_raw();
          r.__wbg_meshrenderer_free(e, 0);
        }
        render(e) {
          r.meshrenderer_render(this.__wbg_ptr, e);
        }
        setColors(e) {
          r.meshrenderer_setColors(this.__wbg_ptr, e);
        }
      }
      const P =
        "undefined" == typeof FinalizationRegistry
          ? { register: () => {}, unregister: () => {} }
          : new FinalizationRegistry((e) =>
              r.__wbg_meshresource_free(e >>> 0, 1)
            );
      class k {
        __destroy_into_raw() {
          const e = this.__wbg_ptr;
        ...
        free() {
          const e = this.__destroy_into_raw();
          r.__wbg_meshresource_free(e, 0);
        }
        constructor(e, t) {
          const n = v(e, r.__wbindgen_malloc),
            _ = f;
          x(t, E);
          const i = r.meshresource_js_constructor(n, _, t.__wbg_ptr);
          return (
            (this.__wbg_ptr = i >>> 0),
        ...
        load(e) {
          const t = this.__destroy_into_raw();
          x(e, U);
          return r.meshresource_load(t, e.__wbg_ptr);
        }
      }
      const D =
        "undefined" == typeof FinalizationRegistry
      ...
      class U {
        ...
        constructor(e) {
          const t = r.webglrenderer_js_constructor(e);
          return (
            (this.__wbg_ptr = t >>> 0),
        ...
        readPixels() {
          return r.webglrenderer_readPixels(this.__wbg_ptr);
        }
      }
      function B() {
        const e = { wbg: {} };
        return (
          ...
          (e.wbg.__wbg_bindRenderbuffer_53eedd88e52b4cb5 = function (e, t, n) {
          ...
          (e.wbg.__wbg_createObjectURL_6e98d2f9c7bd9764 = function () {
            return o(function (e, t) {
              const n = w(
                ...
                _ = f;
              d().setInt32(e + 4, _, !0), d().setInt32(e + 0, n, !0);
            }, arguments);
          }),
          (e.wbg.__wbg_createProgram_8ff56c485f3233d0 = function (e) {
            const t = e.createProgram();
          ...
          (e.wbg.__wbg_envtextures_new = function (e) {
            return E.__wrap(e);
          }),
          ...
          (e.wbg.__wbg_getAttribLocation_9db82d01924fa43d = function (
            ...
            return e.getAttribLocation(t, h(n, r));
          }),
          (e.wbg.__wbg_getExtension_e6c97409b224b5dc = function () {
            return o(function (e, t, n) {
              const r = e.getExtension(h(t, n));
              return a(r) ? 0 : c(r);
            }, arguments);
          }),
          (e.wbg.__wbg_getParameter_1f0887a2b88e6d19 = function () {
          ...
          (e.wbg.__wbg_getProgramInfoLog_631c180b1b21c8ed = function (e, t, n) {
            const _ = t.getProgramInfoLog(n);
            var i = a(_) ? 0 : w(_, r.__wbindgen_malloc, r.__wbindgen_realloc),
              b = f;
            d().setInt32(e + 4, b, !0), d().setInt32(e + 0, i, !0);
          }),
          (e.wbg.__wbg_getProgramParameter_0c411f0cd4185c5b = function (
            e,
            t,
          ...
          (e.wbg.__wbg_getUniformLocation_838363001c74dc21 = function (
            ...
            const _ = e.getUniformLocation(t, h(n, r));
            return a(_) ? 0 : c(_);
          }),
          (e.wbg.__wbg_get_67b2ba62fc30de12 = function () {
            return o(function (e, t) {
          ...
          (e.wbg.__wbg_meshrenderer_new = function (e) {
            return T.__wrap(e);
          }),
          (e.wbg.__wbg_name_f5089a8a6c7a983a = function (e, t) {
            const n = w(t.name, r.__wbindgen_malloc, r.__wbindgen_realloc),
              _ = f;
            d().setInt32(e + 4, _, !0), d().setInt32(e + 0, n, !0);
          }),
          (e.wbg.__wbg_new_23a2665fac83c611 = function (e, t) {
            try {
              ...
              const _ = new Promise((e, t) => {
                ...
                try {
                  return (function (e, t, n, _) {
                    r.closure507_externref_shim(e, t, n, _);
                  })(_, n.b, e, t);
                } finally {
                  n.a = _;
                }
          ...
          (e.wbg.__wbg_readPixels_05b426266eb8041a = function () {
            return o(function (e, t, n, r, _, i, c, o, a) {
              e.readPixels(
                t,
                n,
                r,
          ...
          (e.wbg.__wbg_subarray_769e1e0f81bb259b = function (e, t, n) {
            return e.subarray(t >>> 0, n >>> 0);
          }),
          (e.wbg.__wbg_subarray_fa0950d06c298557 = function (e, t, n) {
            return e.subarray(t >>> 0, n >>> 0);
          ...
          (e.wbg.__wbg_texImage2D_297bb8474cd4e8b8 = function () {
            return o(function (e, t, n, r, _, i, c, o, a, f, g) {
              e.texImage2D(
                t >>> 0,
                n,
                r,
          ...
          (e.wbg.__wbg_texImage2D_7b15c62fc9c12b16 = function () {
            return o(function (e, t, n, r, _, i, b) {
              e.texImage2D(t >>> 0, n, r, _ >>> 0, i >>> 0, b);
            }, arguments);
          }),
          (e.wbg.__wbg_texImage2D_7fafc5db9861e235 = function () {
          ...
          (e.wbg.__wbg_texImage2D_b8edcb5692f65f88 = function () {
            return o(function (e, t, n, r, _, i, b, c, o, a) {
              e.texImage2D(t >>> 0, n, r, _, i, b, c >>> 0, o >>> 0, a);
            }, arguments);
          }),
          (e.wbg.__wbg_texImage2D_d40a00b9c1254ee4 = function () {
          ...
          (e.wbg.__wbindgen_bigint_get_as_i64 = function (e, t) {
            const n = "bigint" == typeof t ? t : void 0;
            d().setBigInt64(e + 8, a(n) ? BigInt(0) : n, !0),
              d().setInt32(e + 0, !a(n), !0);
          }),
          (e.wbg.__wbindgen_boolean_get = function (e) {
            return "boolean" == typeof e ? (e ? 1 : 0) : 2;
          }),
          ...
          (e.wbg.__wbindgen_closure_wrapper1698 = function (e, t, n) {
            const _ = (function (e, t, n, _) {
              const i = { a: e, b: t, cnt: 1, dtor: n },
                b = (...e) => {
                  i.cnt++;
                  const t = i.a;
                  ...
                  try {
                    ...
                    0 == --i.cnt
                      ? (r.__wbindgen_export_5.get(i.dtor)(t, i.b),
                        p.unregister(i))
                      : (i.a = t);
                  }
                };
          ...
          (e.wbg.__wbindgen_closure_wrapper185 = function (e, t, n) {
            return y(e, t, 5, I);
          }),
          (e.wbg.__wbindgen_closure_wrapper186 = function (e, t, n) {
            return y(e, t, 5, R);
          }),
          (e.wbg.__wbindgen_debug_string = function (e, t) {
            const n = w(m(t), r.__wbindgen_malloc, r.__wbindgen_realloc),
              _ = f;
            d().setInt32(e + 4, _, !0), d().setInt32(e + 0, n, !0);
          }),
          (e.wbg.__wbindgen_error_new = function (e, t) {
          ...
          (e.wbg.__wbindgen_number_get = function (e, t) {
            const n = "number" == typeof t ? t : void 0;
            d().setFloat64(e + 8, a(n) ? 0 : n, !0),
              d().setInt32(e + 0, !a(n), !0);
          }),
          (e.wbg.__wbindgen_string_get = function (e, t) {
            const n = "string" == typeof t ? t : void 0;
            var _ = a(n) ? 0 : w(n, r.__wbindgen_malloc, r.__wbindgen_realloc),
              i = f;
            d().setInt32(e + 4, i, !0), d().setInt32(e + 0, _, !0);
          }),
          (e.wbg.__wbindgen_string_new = function (e, t) {
            return h(e, t);
          }),
      ...
      async function z(e) {
        ...
        void 0 !== e &&
          ...
          void 0 === e &&
            (e = new URL(
              "" + new URL(n(558269), n.b).href,
              "file:///mnt/engflow/worker/work/5/exec/bazel-out/k8-opt-exec-ST-50735076bf96/bin/web/src/pages/export_website/webpack_cli_page_/webpack_cli_page.runfiles/_main/node_modules/.aspect_rules_js/@canva+fragl-rs@1.0.4/node_modules/@canva/fragl-rs/dist/index.js"
            ));
        const t = B();
        ("string" == typeof e ||
          ("function" == typeof Request && e instanceof Request) ||
          ("function" == typeof URL && e instanceof URL)) &&
          (e = fetch(e));
        const { instance: i, module: b } = await (async function (e, t) {
          if ("function" == typeof Response && e instanceof Response) {
            if ("function" == typeof WebAssembly.instantiateStreaming)
              try {
                return await WebAssembly.instantiateStreaming(e, t);
    ...
    558269: (e, t, n) => {
      e.exports = n.p + "bed35172fb88d129.wasm";
    },
    788226: (e, t, n) => {
      e.exports = n.p + "896447a5511993d2.wasm";
    },
  },
]);
//# sourceMappingURL=sourcemaps/15e2f118ea72bb1b.vendor.js.map
